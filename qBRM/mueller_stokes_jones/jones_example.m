...
angles = 0:180;
wps = jones_rotate(jones_waveplate(0.25, 'wav'), 45, 'deg');
lightin = jones_lphorizontal();
tissue_rot = jones_rotate(jones_waveplate(0.9, 'wav'), 45, 'deg');
tissue = jones_rotate(tissue_rot, angles, 'deg');
lightout = jones(jones_linpolarizer(),tissue,wps,lightin);
