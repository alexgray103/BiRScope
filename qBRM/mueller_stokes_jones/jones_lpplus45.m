function V = jones_lpplus45(varargin)
    ...
    %
    %  See also:
    %     jones_lpminus45 jones_lphorizontal jones_lpvertical
    %
    %  File information:
