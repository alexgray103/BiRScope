function V = jones_cpleft(varargin)
    %function V = jones_cpleft(varargin)
    %Return the Jones vector for left-turn circularly polarized light.
    %
    %  Syntax:
    %     V = jones_cpleft()
    %     V = jones_cpleft(p)
    ...
    %
    %  Description:
    %     V = jones_cpleft() returns the Jones vector
    %     for light with left-turn circular polarization and amplitude 1.
    %
    %     V = jones_cpleft(p) returns the Jones vector
    %     for light with left-turn circular polarization and amplitude p.
    %
    %     A = jones_cpleft(P), where P is a m x n x ... array of
    ...
    %
    %  See also:
    %     jones_cpright jones_lpvertical
    %
    %  File information:
    ...
    if (numel(amplitude) > 1) || was_cell
        ...
        for Vi=1:numel(V)
            ...
            V{V_subs{:}} = s_cpleft(amplitude(V_subs{:}));
        end
        
    else
        
        V = s_cpleft(amplitude);
